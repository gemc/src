...
classes=( goptions guts gfields glogging gfactory gtouchable ghit gtranslationTable gdata gdynamicDigitization g4display g4dialog )

classes_to_do=(gdetector   gtranslationTable

...
- Redesigned the geometry-tree right panel: style buttons (wireframe / surface / cloud / centre)
  are now anchored at the very top and always visible; the properties section expands to fill all
  remaining height so the parameters box grows with the window; added a thin black border and a

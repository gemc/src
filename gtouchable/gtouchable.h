...
private:
    ...
    double eMultiplier;
    ///< Energy multiplier for energy sharing. Set by processGTouchable in the digitization plugin. Defaulted to 1. Used to share energy / create new hits.
    ...
    ///< Physical dimensions of the detector element. Saved to be used in GDynamicDigitization if needed

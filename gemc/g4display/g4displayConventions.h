...
inline constexpr char GDEFAULTVIEWERDRIVER[] = "TOOLSSG_QT_GLES";

// Default viewer window size (WIDTHxHEIGHT).
inline constexpr char GDEFAULTVIEWERSIZE[] = "800x800";

// Default viewer window position (X+Y or -X+Y depending on window manager conventions).
inline constexpr char GDEFAULTVIEWERPOS[] = "-400+100";

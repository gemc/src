...
void TextProgressBar::setProgress(int p) {
	...
	// Note: progress is computed from the current threshold (indexStep) and step size (singleStep),
	// not directly from p, because printing is throttled to discrete internal steps.

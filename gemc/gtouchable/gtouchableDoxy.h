...
/// \tableofcontents
///
/// \image html gtouchable-flow.svg "Detector-cell identity and hit-key flow" width=900px
///
...
/// - A discriminator rule that depends on the touchable type
///   (readout/flux/particle_counter/dosimeter/integral_counter).
///
...
///   may influence logger behavior for this module, but no runtime configuration keys are read by the data
///   structure.
///
...
/// - Extension points: The rules that assign readout timing, energy multipliers, and other
///   digitization-dependent attributes are typically implemented in digitization plugins. This module focuses
///   on the data structure and comparison semantics used by the hit processing pipeline.
///
...
/// - Level 2: detailed informational messages, typically used for validation and troubleshooting (e.g.
///   existence checks).

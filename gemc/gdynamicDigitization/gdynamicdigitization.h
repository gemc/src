...
#include <gemc/ghit/ghit.h>
#include <gemc/gdata/gDigitizedData.h>
#include <gemc/gdata/gTrueInfoData.h>
#include <gemc/gtranslationTable/gtranslationTable.h>
...
public:
    ...
    [[nodiscard]] virtual CollectionMode collection_mode() const { return CollectionMode::event; }
